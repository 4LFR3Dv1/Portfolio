...
| R2.6 | Shadow / Preview Deployment | **MATERIALIZED / AWAITING PUBLIC WITNESS** |
...
R2_4_COMPLETE=true
R2_5_COMPLETE=true
R2_6_MATERIALIZED=true
R2_6_COMPLETE=false
NEXT=R2.6 — Isolated public preview deployment + environmental witness
```
